...
public class TestHelper {
	...
	public static List<Result<EObject>> compileProject(String toParse,
		...
		return compileProject(new ArrayList<>(toParse1.keySet()), metamodelSourceFactory, buildSourceProvider(toParse1));
	}
	...
	public static List<Result<EObject>> compileProject(List<String> entryPoints, MetamodelSource.Factory<?> typeSourceFactory,
	...
	public static List<Result<EObject>> compileProject(List<EPackage> packages, Map<String, String> allSources) {
		return compileProject(new ArrayList<>(allSources.keySet()), buildMetamodelSourceFactory(packages), buildSourceProvider(allSources));
	}
	
	public static List<Result<EObject>> compileProject(Resource resource, Map<String, String> allSources) {
		return compileProject(new ArrayList(allSources.keySet()), buildMetamodelSourceFactory(resource), new SimpleSourceProvider(allSources));
	}

	public static MetamodelSource.Factory buildMetamodelSourceFactory(
			Resource resource) {
